...
async def debug_pinecone():
    ...
    try:
        from backend.rag_engine import _index  # uses auto-create logic
        idx = _index()
        stats = idx.describe_index_stats()
        return {"ok": True, "index": index_name, "total_vectors": stats.total_vector_count, "dimension": stats.dimension, "key_prefix": key[:12]}
